...
We use Your Personal Data to provide, operate, and support the Service,
including analytics and advertising features. By using the Service, You agree to the collection and use of information in accordance with this Privacy Policy.
...
*   **Application** refers to My OPIC Story, the software program provided by the Company.
...
#### Uploaded Images and User Content
When You use the Service, You may upload images and provide text descriptions. These images and texts may contain personal information depending on their content.

Uploaded images and text inputs are transmitted to our servers and processed for the purpose of providing the Service, including AI-based analysis and content generation.
...
Usage Data may include device type, operating system, app version, IP address, timestamps, and diagnostic data. This data is used for analytics, service stability, and performance improvement.
